...
function Login() {
    ...
    const login = () => {
        let Info:User = userInfo as any

        if(Info.username && Info.password) {
            UserStore.login(Info).then((res) => {
                sessionStorage.setItem('userId', res);
                router('/')
            })
            
        } else {
            console.log("用户名或密码不可为空");
        }
                ...
                <div className='loginForm'>
                    ...
                    <div className='formContent'>
                        <div className='inputBox'>
                            ...
                            <input type="text" onChange={(e) => usernameChange(e)} placeholder='请输入用户名' required/>
                        </div>
                        <div className='inputBox'>
                            ...
                            <input type="password" onChange={(e) => passwordChange(e)}  placeholder='请输入密码' required />
                        </div>
